...
import com.smbtec.xo.tinkerpop.blueprints.test.relation.typed.composite.A;
import com.smbtec.xo.tinkerpop.blueprints.test.relation.typed.composite.B;
import com.smbtec.xo.tinkerpop.blueprints.test.relation.typed.composite.TypedManyToManyRelation;
import com.smbtec.xo.tinkerpop.blueprints.test.relation.typed.composite.TypedOneToManyRelation;
import com.smbtec.xo.tinkerpop.blueprints.test.relation.typed.composite.TypedOneToOneRelation;

@RunWith(Parameterized.class)
public class TypedRelationTest extends AbstractTinkerPopXOManagerTest {
    ...
    public static Collection<Object[]> getXOUnits() throws URISyntaxException {
        return xoUnits(A.class, B.class, TypedOneToOneRelation.class, TypedOneToManyRelation.class,
    ...
    public void oneToOne() {
        ...
        assertThat(executeQuery("g.E").getColumn(GremlinQuery.EDGE_COLUMN_NAME), hasItem(equalTo(relation1)));
        ...
        assertThat(executeQuery("g.E").getColumn(GremlinQuery.EDGE_COLUMN_NAME), hasItem(equalTo(relation2)));
    ...
    public void oneToMany() {
        ...
        assertThat(executeQuery("g.E").<TypedOneToManyRelation> getColumn(GremlinQuery.EDGE_COLUMN_NAME),
        ...
        xoManager.flush();
        assertThat(executeQuery("g.E").<TypedOneToManyRelation> getColumn(GremlinQuery.EDGE_COLUMN_NAME), equalTo(null));
    }
    ...
    public void manyToMany() {
        ...
        assertThat(relationB2_2.getA(), equalTo(a));
        assertThat(relationB2_2.getB(), equalTo(b2));
        assertThat(executeQuery("g.E").<TypedManyToManyRelation> getColumn(GremlinQuery.EDGE_COLUMN_NAME),
